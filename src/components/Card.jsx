...
const Card = ({ vehicle, handelclick }) => {
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white rounded-2xl shadow-md overflow-hidden group hover:shadow-xl transition duration-300">
      ...
      <div className="p-4 sm:p-5">
        ...
        {/* BUTTON */}
        <button onClick={() => handelclick(vehicle._id)} className="w-full bg-blue-600 text-white py-2 rounded-full text-sm sm:text-base hover:bg-blue-700 transition">
          View More
        </button>
      </div>
    </div>
